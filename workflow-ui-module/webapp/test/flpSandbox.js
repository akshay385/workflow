		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mynamespaceworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mynamespaceworkflowuimodule-display": {
								"semanticObject": "mynamespaceworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mynamespace.workflowuimodule",
									"url": sap.ui.require.toUrl("mynamespace/workflowuimodule")
								}
							}
						}
					}
